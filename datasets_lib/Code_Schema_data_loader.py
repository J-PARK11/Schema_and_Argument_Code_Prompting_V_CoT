...
class V_COT_SMART101_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return im_name, im_path, pid, q_stn_out, opts, option_answer, lbl, img_dcp, pseudo_code
...
def img_dcp_train_collator_fn(data, processor, device):
    ...
    messages = []
    for im_name, im_path, pid, q_stn_out, opts, option_answer, lbl, img_dcp, pseudo_code in data:
        ...
        prompt = [
            ...
            {   'role': 'assistant', 'content': [{'type': 'text', 'text': {option_answer}}]}]
